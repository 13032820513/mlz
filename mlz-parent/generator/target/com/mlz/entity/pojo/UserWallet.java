...
public class UserWallet implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(", lowerUserId=").append(lowerUserId);
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getLowerUserId() == null ? other.getLowerUserId() == null : this.getLowerUserId().equals(other.getLowerUserId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getLowerUserId() == null) ? 0 : getLowerUserId().hashCode());
